file:///C:/Users/victo/Documents/Plantilla/Proyecto/usuario.html/* -------------------- Check Browser --------------------- */
$('.registrar').click(function(e){
	e.preventDefault();
	$('#myModalR').modal('show');
});
$('.recuperarc').click(function(e){
	e.preventDefault();
	$('#myModalRC').modal('show');
});
// Modal informacion docente Prestamo
$('.registroPrestamo').click(function(e){
	e.preventDefault();
	$('#myModalD').modal('show');
});
// Modal editar Prestamo
$('.editarPresamo').click(function(e){
	e.preventDefault();
...
$(".editarUsuario").click(function(e){
    ...
    var rol="";
    // Obtenemos todos los valores contenidos en los <td> de la fila
    cedula=$(this).parents("tr").find(".cedula").html();
    nombre=$(this).parents("tr").find(".nombre").html();
    correo=$(this).parents("tr").find(".correo").html();
    telefono=$(this).parents("tr").find(".telefono").html();
    contrasena=$(this).parents("tr").find(".password").html();
    rol=$(this).parents("tr").find(".id_rol").html();
    var estado=$(this).parents("tr").find(".estado").find("span").html();
    if(estado=='Activo'){ estado=1;}else{estado=0;}
    $('#cedula').val(cedula);
    $('#nombre_usuario').val(nombre);
    $('#correo').val(correo);
    $('#telefono').val(telefono);
    $('#password_modal').val(contrasena);
    $('#selectEstadoModal').val(estado).attr("selected",true);
    $("#selectRolModal").val(rol).attr("selected",true);
...
$(".borrarUsuario").click(function(e){
    ...
    var estado=$(this).parents("tr").find(".estado").find("span").html();
    var rol=$(this).parents("tr").find(".nombre_rol").html();
...
$('.modificarAula').click(function(e){
	e.preventDefault();
	$('#myModalEditarAula').modal('show');
});
// Modal eliminar aulas
$('.borrarAula').click(function(e){
	e.preventDefault();
...
$(".editarRol").click(function(e){
    ...
    var permisos="";
    // Obtenemos todos los valores contenidos en los <td> de la fila
    id=$(this).parents("tr").find(".id_rol").html();
    rol=$(this).parents("tr").find(".rol").html();
    permisos=$(this).parents("tr").find(".permisos").html();
    $('#rol_modal').val(rol);
    $('.id_rol_modal').val(id);
...
$(".borrarRol").click(function(e){
    ...
    $('#textBorrar').text("Está seguro que desea eliminar el rol de "+rol+"? ");
    $('.id_rol_modal').val(id);
	$('#myModalEliminarRol').modal('show');
});
	   // Carga de contenido de prestamo
	$("#registroIP").click(function(e){
		e.preventDefault();
	...
	$("#registroUs").click(function(e){
		e.preventDefault();
		$(".texto>a").text("Registrar");
		$("#registroU").css("display","block");
		$("#consultaU").css("display","none");
		$("#tablaU").css("display","none");
	});
	$("#consultaUs").click(function(e){
		e.preventDefault();
		$(".texto>a").text("Consultar");
	...
	// Carga de contenido de reparacion
	$("#registrarR").click(function(e){
		e.preventDefault();
		$(".texto>a").text("Registrar");
		$("#registroR").css("display","block");
		$("#consultaR").css("display","none");
		$("#tablaR").css("display","none");
	});
	$("#consultarR").click(function(e){
		e.preventDefault();
		$(".texto>a").text("Consultar");
	...
	$("#registrarA").click(function(e){
		e.preventDefault();
		$(".texto>a").text("Registrar");
		$("#registroA").css("display","block");
		$("#consultaA").css("display","none");
		$("#tablaA").css("display","none");
	});
	$("#consultarA").click(function(e){
		e.preventDefault();
		$(".texto>a").text("Consultar");
